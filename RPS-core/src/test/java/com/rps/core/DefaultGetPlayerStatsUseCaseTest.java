...
public class DefaultGetPlayerStatsUseCaseTest {
    ...
    public void setup() {
        ...
        defaultCreateGameResultUseCase.execute(new CreateGameResultUseCase.Request(player2, player1, Throw.SPOCK, Throw.ROCK));
        defaultCreateGameResultUseCase.execute(new CreateGameResultUseCase.Request(player1, player3, Throw.ROCK, Throw.SPOCK));
